...
(function(mod) {
    ...
    function tokenBase(stream, state) {
      ...
      if (support.hexNumber &&
        ...
        return state.tokenize(stream, state);
          ...
          || (support.charsetCast && ch == "_" && stream.match(/[a-z\u4E00-\u9FFF][a-z0-9]*/i)))
        ...
        if (support.ODBCdotTable && stream.match(/^[\w\d_\u4E00-\u9FFF]+/))
          return "variable-2";
  ...
  function hookIdentifier(stream) {
    ...
    return stream.eatWhile(/\w\u4E00-\u9FFF/) ? "variable-2" : null;
  }
  ...
  function hookVar(stream) {
    ...
    if (stream.eat("'")) {
      ...
      stream.match(/^.*`/);
      return "variable-2";
    } else if (stream.match(/^[\u4E00-\u9FFF0-9a-zA-Z$\.\_]+/)) {
      return "variable-2";
    }
    return null;
  };
  ...
  function hookClient(stream) {
    ...
    return stream.match(/^[\u4E00-\u9FFFa-zA-Z.#!?]/) ? "variable-2" : null;
  }
