      ...
      <div class="rule-operation">
        ...
        >
          <el-form-item label="规则名称" prop="ruleName">
            <el-input
              class="size"
              v-model="ruleOperationForm.ruleName"
              autocomplete="off"
              clearable
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="规则类别：" prop="ruleCategory">
            <el-select
              v-model="ruleOperationForm.ruleCategory"
              placeholder="请选择"
              clearable
            >
          ...
          <el-form-item label="规则分类：" prop="folderName">
            <el-select
              v-model="ruleOperationForm.folderName"
              placeholder="请选择"
              multiple
              collapse-tags
            >
              <el-option
                :value="ruleOperationForm.folderName"
                style="height: auto"
              >
          ...
          <el-form-item label="创建时间：" prop="createTime">
            <el-input
              class="size"
              v-model="ruleOperationForm.createTime"
              autocomplete="off"
              disabled
            ></el-input>
          </el-form-item>
  ...
  data() {
    return {
      ...
      ruleOperationFormRules: {
        ...
        ruleCategory: [{ required: true, message: "请选择规则类别" }],
        folderName: [
          { required: true, message: "请选择规则分类", trigger: "blur" }
        ],
        username: [{ required: true, message: "请输入创建人" }],
        ...
        if (this.type == "edit") {
          if (this.checkedData.length > 0) {
            ...
            this.ruleOperationForm.ruleCategory =
              this.checkedData[0].ruleCategory == "住院规则"
                ? 2
                : this.checkedData[0].ruleCategory == "门诊规则"
                ? 1
                : "";
