<template>
    <div class='behaviorList'>
        ...
        <div class="listDisplay">
            <el-table :data="tableData" border style="100%" :height="tableHeight-10" @selection-change="handleSelectionChange" :header-cell-style="{textAlign:'center'}" class="demo-ruleForm" v-loading="tableLoading">
                <el-table-column type="selection" header-align="center" align="center" width="50"></el-table-column>
                <el-table-column type="index" label="序号" align="center" width="50"></el-table-column>
                <el-table-column prop="appCode" header-align="center" align="center" label="应用编码"></el-table-column>
                <el-table-column prop="module" header-align="center" align="center" width="150" label="模块"></el-table-column>
                <el-table-column prop="logType" header-align="center" align="center" label="日志类型"></el-table-column>
                <el-table-column prop="remoteIp" header-align="center" align="center" label="操作ip地址"></el-table-column>
                <el-table-column prop="operateType" header-align="center" align="center" label="操作类型"></el-table-column>
                ...
                <el-table-column prop="result" header-align="center" align="center" min-width='100' label="响应参数"></el-table-column>
                <el-table-column prop="createId" header-align="center" align="center" label="创建人ID"></el-table-column>
...
export default {
    ...
    methods:{
        ...
        initDataList(){
            ...
            this.$http({
                url:this.$http.adornUrl('/actionLog/selectPage'),
                method: 'post',
        ...
        getInitFrom(){
            this.$http({
                url:this.$http.adornUrl(`/actionLog/selectByUuid/${this.selectByUuid}`),
                method: 'get',
            }).then(({data}) =>{
                if(data && data.code === 200){
        ...
        getChooseExport(){
            ...
            if(this.seleteLengthData.length !=1){
                ...
                window.location.href = this.$http.adornUrl("/actionLog/logDataExport?token=") + this.$cookie.get("token") + "&idString=" + seleteIds;
            //  let url =
            //     this.$http.adornUrl(
            //     '/actionLog/logDataExport?idString='+seleteIds +'token=') + this.$cookie.get("token");
            // window.open(url);
                // console.log(this.seleteId)
            }else{
                this.$message({
                    message: "请选择至少一条数据",
                    type: "warning"
        ...
        //全部导出
        getExportClick(){
            window.location.href = this.$http.adornUrl("/actionLog/logDataExport?token=") + this.$cookie.get("token") + "&exportAll=" + this.exportAll;
        }
