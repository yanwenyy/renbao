...
const mainRoutes = {
  ...
  children: [
    ...
    { path: '/component/BaseCodeTreeInfo', component: _import('modules/BaseCodeInfo/component/BaseCodeTreeInfo'), name: 'BaseCodeTreeInfo', meta: { title: 'BaseCodeTreeInfo', isTab: true } },
  ],
